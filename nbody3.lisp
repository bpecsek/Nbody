...
(declaim (start-block offset-momentum body-scale energy advance))
...
(defun main ()
 (let ((n (parse-integer (or (car (last #+sbcl sb-ext:*posix-argv*)) "50000000"))))
   (nbody n)))
